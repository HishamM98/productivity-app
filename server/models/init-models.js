...
function initModels(sequelize) {
  ...
  task_tags.belongsToMany(tasks, {
    as: "task_id_tasks",
    through: task_tag_relations,
    foreignKey: "tag_id",
    otherKey: "task_id",
  });
  tasks.belongsToMany(task_tags, {
    as: "tag_id_task_tags",
    through: task_tag_relations,
    foreignKey: "task_id",
    otherKey: "tag_id",
